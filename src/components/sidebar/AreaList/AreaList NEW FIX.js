...
function AreaList(props) {
  ...
  // var topicList = ADCache.TopicList[selectedArea];
  ...
  const areaList           = [
      {
        ...
        "AID": 1,
        "Status": "ACT",
        "AIDName": "General (Confirmatory)",
        "AnsweredCount": 1,
        "TotalCount": 2,
        "UnderReviewCount": 0,
        "ProjectAnsweredCount": 1,
        "ProjectTotalCount": 19,
        "ProjectUnderReviewCount": 0
      }];
  ...
  function getAreaTopics(pid, aid)
  {
      if (userID) {
        let key = aid;
        if (! ADCache.ResetTopics) { // Force reset of topicList
      ...
      {areaList ?
        <NoSsr>
          ...
          <div className={classes.divider} />
            {/* <TopicList jwt={jwt} rt={rt} ra={ra} frt={frt} fra={fra}></TopicList> */}
        </NoSsr>
      : null }
    </div>
  );
